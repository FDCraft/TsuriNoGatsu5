...
craftingTable.addShapeless("doughchange2", <item:candlelight:dough>, [<item:farmersdelight:wheat_dough>]);
craftingTable.addShapeless("doughchange3", <item:bakery:dough>, [<item:candlelight:dough>]);
craftingTable.addShapeless("doughchange4", <item:vintagedelight:oat_dough>, [<item:bakery:dough>]);
